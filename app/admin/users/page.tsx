    ...
    <div className="space-y-8">
      ...
      <div className="flex items-start justify-between gap-4">
        <div>
          ...
          <p className="text-sm text-slate-500">{users.length} total accounts on the platform</p>
        </div>
        {/* Role summary chips */}
          ...
          <table className="w-full text-sm">
            ...
            <tbody className="divide-y divide-slate-100/60">
              {users.map((u) => {
                ...
                return (
                  <tr key={u.id} className={`hover:bg-slate-50/50 transition-colors ${cfg.row}`}>
                    {/* User cell */}
                    ...
                    {/* Trips owned */}
                    <td className="px-5 py-3 text-right tabular text-slate-700 font-medium hidden md:table-cell">
                      {u.tripsOwned > 0 ? (
                    ...
                    {/* Trips joined */}
                    <td className="px-5 py-3 text-right tabular text-slate-600 hidden lg:table-cell">
                      {u.tripsJoined}
                    </td>
      ...
      <div className="glass rounded-xl px-5 py-4">
        <p className="text-xs font-semibold text-slate-500 uppercase tracking-wide mb-3">Role definitions</p>
