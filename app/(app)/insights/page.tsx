  ...
  if (!insights || insights.tripCount === 0) {
    return (
      <div className="flex flex-col items-center justify-center py-24 text-center">
        ...
        <p className="text-slate-500 text-sm mb-5">Create trips and add expenses to see your travel analytics.</p>
        <Link href="/trips"
  ...
  return (
    <div className="max-w-3xl">
      <div className="mb-6">
        ...
        <p className="text-slate-500 text-sm mt-1">Across all your trips</p>
      </div>
        ...
        {insights.byTrip.map((t) => (
          <Link key={t.tripId} href={`/trips/${t.tripId}/insights`}
            ...
            <div className="flex-1 min-w-0">
              ...
              <p className="text-xs text-slate-500">{t.expenseCount} expenses · {t.memberCount} members</p>
            </div>
            <p className="text-sm font-semibold text-slate-700 tabular shrink-0"
