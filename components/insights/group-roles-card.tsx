...
export function GroupRolesCard({ data }: Props) {
  ...
  return (
    <div className="glass rounded-2xl p-5">
      <h2 className="text-sm font-semibold text-slate-700 mb-4">Group dynamics</h2>

      {/* Fairness score */}
      {data.memberRoles.length >= 2 && (
        <div className="mb-5 p-3.5 bg-white/40 rounded-xl border border-white/60">
          <div className="flex items-center justify-between mb-2">
            <span className="text-xs font-medium text-slate-500">Payment fairness</span>
